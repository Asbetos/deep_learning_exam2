...
TTA_TRANSFORMS = 5  # Number of TTA variations
...
# OPTIMAL_THRESHOLDS = [0.5, 0.4, 0.1, 0.3, 0.45, 0.4, 0.5, 0.3, 0.25, 0.45]
...
def get_tta_transforms(image_size):
    ...
    tta_list = [
        ...
        A.Compose([
            A.CenterCrop(height=int(image_size * 0.9), width=int(image_size * 0.9)),
            A.Resize(image_size, image_size),
            A.Normalize(mean=MEAN, std=STD),
            ToTensorV2(),
        ]),
