...
# THRESHOLD = 0.5
OPTIMAL_THRESHOLDS = [0.4, 0.55, 0.6, 0.65, 0.65, 0.65, 0.6, 0.65, 0.65, 0.75]
...
def model_definition(pretrained=False):
    ...
    if pretrained:
        ...
        model = timm.create_model('swin_base_patch4_window7_224', pretrained=False, num_classes=OUTPUTS_a)
        print("Model: Swin Transformer (swin_base_patch4_window7_224)")
    else:
